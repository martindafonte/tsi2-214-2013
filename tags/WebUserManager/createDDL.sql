...
CREATE TABLE DESARROLLADOR (ID BIGINT NOT NULL, APELLIDO VARCHAR(255), NICK VARCHAR(255), NOMBRE VARCHAR(255), PASS VARCHAR(255), PROVIDERID VARCHAR(255), PRIMARY KEY (ID))
